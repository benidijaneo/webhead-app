...
btnMar1.addEventListener("click", (e) => {
  ...
  showAnswer(answer1, null, null, null, null, null, answers[1].cssMargin[1].a);
...
btnMar2.addEventListener("click", (e) => {
  ...
  showAnswer(answer1, null, null, null, null, null, answers[1].cssMargin[2].a);
...
btnMar3.addEventListener("click", (e) => {
  ...
  showAnswer(answer1, null, null, null, null, null, answers[1].cssMargin[3].a);
...
btnPad1.addEventListener("click", (e) => {
  ...
  showAnswer(answer1, null, null, null, null, null, answers[1].cssPadding[1].a);
...
btnPad2.addEventListener("click", (e) => {
  ...
  showAnswer(answer1, null, null, null, null, null, answers[1].cssPadding[2].a);
...
btnOpe1.addEventListener("click", (e) => {
  ...
  showAnswer(answer1, null, null, null, null, null, answers[2].jsOperator[1].a);
...
btnOpe2.addEventListener("click", (e) => {
  ...
  showAnswer(answer1, null, null, null, null, null, answers[2].jsOperator[2].a);
...
btnOpe3.addEventListener("click", (e) => {
  ...
  showAnswer(answer1, null, null, null, null, null, answers[2].jsOperator[3].a);
...
btnOpe4.addEventListener("click", (e) => {
  ...
  showAnswer(answer1, null, null, null, null, null, answers[2].jsOperator[4].a);
...
btnOpe5.addEventListener("click", (e) => {
  ...
  showAnswer(answer1, null, null, null, null, null, answers[2].jsOperator[5].a);
